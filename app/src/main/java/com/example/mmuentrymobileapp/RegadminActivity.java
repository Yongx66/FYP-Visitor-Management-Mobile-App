        ...
        signupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (username.isEmpty() || password.isEmpty() || confirmPassword.isEmpty()) {
                    Toast.makeText(RegadminActivity.this, "Please fill in all fields", Toast.LENGTH_SHORT).show();
                } else if (!password.equals(confirmPassword)) {
                    Toast.makeText(RegadminActivity.this, "Passwords do not match", Toast.LENGTH_SHORT).show();
                } else {
        ...
        protected void onPostExecute(String response) {
            ...
            if (response != null) {
                try {
                    ...
                    if (status) {
                        Toast.makeText(RegadminActivity.this, "Admin registered successfully", Toast.LENGTH_SHORT).show();
                        // Handle successful registration
                    } else {
                        String errorMessage = jsonResponse.getString("message");
                        Toast.makeText(RegadminActivity.this, "Registration failed: " + errorMessage, Toast.LENGTH_SHORT).show();
